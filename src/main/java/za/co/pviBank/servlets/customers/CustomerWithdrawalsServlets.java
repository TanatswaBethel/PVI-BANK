...
@WebServlet("/customer-withd.jsp")
public class CustomerWithdrawalsServlets extends HttpServlet {
			...
			if (foundAccount != null) {
				try {
					...
					Transactions transactions = 
							new Transactions( accountNumber,  account.getCardNumber(),
									withdrawAmount,  account.getAccountBalance(),
									 "WITHDRAWALS", LocalDateTime.now());
				...
				req.getRequestDispatcher("customer-withdrawals.jsp").forward(req, resp);
			}
